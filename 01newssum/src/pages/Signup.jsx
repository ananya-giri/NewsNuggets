  ...
  return (
    <div className="flex items-center justify-center min-h-[85vh] px-4 animate-fade-in">
      <div className="w-full max-w-md p-10 space-y-8 glass-card rounded-[2.5rem] shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-brand-secondary/20 rounded-full blur-3xl"></div>
        ...
        <div className="text-center relative z-10">
          ...
          <h2 className="text-3xl font-black text-white tracking-tight">Join NewsNugget</h2>
          <p className="mt-2 text-slate-400 font-medium">Your personalized AI news hub</p>
        </div>
